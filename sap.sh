...
sapsbxinstall(){
URL="https://raw.githubusercontent.com/Hutton-h/science/main/sapsbx.sh"
DEST="$HOME/sapsbx.sh"
...
command -v curl > /dev/null 2>&1 && bash <(curl -Ls https://raw.githubusercontent.com/Hutton-h/science/main/sap.sh) || bash <(wget -qO- https://raw.githubusercontent.com/Hutton-h/science/main/sap.sh)
else
...
echo "Science小钢炮脚本-SAP多账户自动部署并保活脚本【VPS】"
echo "版本：V25.10.5"
echo "*****************************************************"
echo "*****************************************************"
