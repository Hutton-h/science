...
sapsbxinstall(){
URL="https://raw.githubusercontent.com/Hutton-h/science/main/sapsbxh.sh"
...
command -v curl > /dev/null 2>&1 && bash <(curl -Ls https://raw.githubusercontent.com/Hutton-h/science/main/saph.sh) || bash <(wget -qO- https://raw.githubusercontent.com/Hutton-h/science/main/saph.sh)
else
